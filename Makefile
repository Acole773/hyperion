...
libhyburn: builddir
	...
	$(CC) -c $(SOURCE_DIR)/core/read_values.c -o $(OBJECT_DIR)/read_values.o $(CFLAGS) -fPIC
	ar rvs $(OBJECT_DIR)/libhyburn.a $(OBJECT_DIR)/read_values.o
	$(CC) -c $(SOURCE_DIR)/parse-data/parser.c -o $(OBJECT_DIR)/parser.o $(CFLAGS) -fPIC
